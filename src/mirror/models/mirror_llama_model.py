...
class MirrorLlamaModel(
    ...
    def __init__(
        ...
        tokenizer_hf_model_name: str | None = None,
    ) -> None:
        super().__init__()
        default_tokenizer_hf_name = tokenizer_hf_model_name or "meta-llama/Llama-3.2-1B-Instruct"
        ...
        if isinstance(initialization, LlamaConfig):
            ...
            self._preprocessor = MirrorLlamaPreprocessor(tokenizer_hf_model_name or hf_model_name)
